...
resourcemanager_opt_newsize="200"
...
resourcemanager_opt_maxnewsize="200"
...
export YARN_LOG_DIR=/var/opt/teradata/var/log/hadoop/$USER
...
export YARN_PID_DIR=/var/opt/teradata/var/run/hadoop/$USER
